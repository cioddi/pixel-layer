...
class Subdivider {
     ...
     */
    private _generatePoleQuad(indices: Array<number>, i0: number, i1: number, v0x: number, v1x: number, poleY: number): void {
...
export function getFillGranularity(zoom: number): number {
